...
<body>
    <h4>Your quiz is being created!</h4>
    just a moment...
    <?php 
...
$sql = "insert into Quiz values($quiz_id, '" . $_REQUEST["title"]. "','" . $_REQUEST["name"] . "');";
$conn->query($sql);
    ...
    echo "<script>setTimeout(function() {window.location.replace('/Quiz-Sharing')}, 2000);</script>";
    ?>
</body>
</html>
